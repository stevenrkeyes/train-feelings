...
PUNCTUALITY_MIN_TRACKING_MINUTES = int(os.environ.get("PUNCTUALITY_MIN_TRACKING_MINUTES", "30"))
CONSIST_REVERSAL_MAX_GAP_MINUTES = int(os.environ.get("CONSIST_REVERSAL_MAX_GAP_MINUTES", "20"))
OLD_FRIEND_MIN_GAP_MINUTES = int(os.environ.get("OLD_FRIEND_MIN_GAP_MINUTES", "5"))
OLD_FRIEND_DURATION_MINUTES = int(os.environ.get("OLD_FRIEND_DURATION_MINUTES", "2"))
SNORING_STATION_MINUTES = int(os.environ.get("SNORING_STATION_MINUTES", "10"))
