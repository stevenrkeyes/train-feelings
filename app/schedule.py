...
from app.config import EARLY_THRESHOLD_SECONDS, LATE_THRESHOLD_SECONDS
...
def is_train_early(
    ...
    *,
    ...
    """True when the train is more than `threshold` seconds ahead of schedule."""
    limit = EARLY_THRESHOLD_SECONDS if threshold is None else threshold
    min_delay = min_trip_delay(arrival_delay, departure_delay)
